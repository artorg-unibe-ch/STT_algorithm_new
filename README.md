...
Many files in the current repository are not used as they are for bone strength computation. Accordingly the dependencies (requirements.txt) are not correctly given.

The scripts used by Paula Cameron for the soft tissue thickness extraction are: 
* main_stt.py
* Pipeline_Modules/clinical_CT_soft_tissue_extraction
* stt.py
